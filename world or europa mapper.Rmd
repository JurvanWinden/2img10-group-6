...
infection_corona_world_mapper2d <- mapper(dist_object = infection_corona_world_dist,
                                filter_values = list(infection_corona_world$popData2018, infection_corona_world$cases),
...
infection_corona_world_graph2 <- graph.adjacency(infection_corona_world_mapper$adjacency, mode="undirected")
